...
INSERT INTO `system` (`id`, `name`, `display_name`, `value`, `field_type`, `comment`, `timestamp`, `reseller_id`, `brand_id`, `group_title`) VALUES (NULL, 'mail_debug', 'Mail Debug', NULL, 'enable_disable_option', 'To enable mail debug, set it to Enable. Logs will appear at LOG_PATH/flux_mail.log', NULL, '', '', 'email');
...
INSERT INTO `system` (`id`, `name`, `display_name`, `value`, `field_type`, `comment`, `timestamp`, `reseller_id`, `brand_id`, `group_title`) VALUES ('0', 'log_path', 'Log Path', '/var/log/flux/', 'default_system_input', 'FLUX log files path', NULL, '0', '0', 'global');
