...
INSERT INTO `system` (`id`, `name`, `display_name`, `value`, `field_type`, `comment`, `timestamp`, `reseller_id`, `is_display`, `group_title`, `sub_group`) VALUES (NULL, 'debug', 'Debug', '0', 'enable_disable_option', 'To enable call debug, set it to Enable. Logs will appear at /var/log/flux/flux.log', '0000-00-00 00:00:00', '0', '0', 'calls', 'General');
...
INSERT INTO `system` (`id`, `name`, `display_name`, `value`, `field_type`, `comment`, `timestamp`, `reseller_id`, `is_display`, `group_title`, `sub_group`) VALUES (NULL, 'calling_cards_welcome_file', 'Welcome File', 'flux-welcome.wav', 'default_system_input', 'Set your calling card welcome file', '0000-00-00 00:00:00', '0', '0', 'calls', 'Calling Card');
...
INSERT INTO `system` (`id`, `name`, `display_name`, `value`, `field_type`, `comment`, `timestamp`, `reseller_id`, `is_display`, `group_title`, `sub_group`) VALUES (NULL, 'mail_log', 'Mail Log', '/backup/log/flux_email.log', 'default_system_input', NULL, '0000-00-00 00:00:00', '0', '0', 'notifications', 'Email');
