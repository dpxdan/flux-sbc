...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function() {
       ...
       build_grid("sidevices_grid","<?php echo base_url()."accounts/customer_details_json/fluxsbc/$edit_id/"; ?>",<? echo $grid_fields ?>,"");
	...
	<div id="content" class="container-fluid">
		<div class="row">
			...
			<div class="p-4 col-md-12">
                ...
                <?php
                if ((isset($permissioninfo['fluxsbc']['fssipdevices']['create']) && $permissioninfo['fluxsbc']['fssipdevices']['create'] == 0 or $permissioninfo['login_type'] == '-1' or $permissioninfo['login_type'] == '0' or $permissioninfo['login_type'] == '3' or $permissioninfo['login_type'] == '1') or ($permissioninfo['login_type'] == '-1')) {
                    ?>

                    <div class="float-left">
						<a
							href='<?php echo base_url()."fluxsbc/customer_fssipdevices_add/".$edit_id."/"; ?>'
                ...
                if ((isset($permissioninfo['fluxsbc']['fssipdevices']['delete'])) && ($permissioninfo['fluxsbc']['fssipdevices']['delete'] == 0) && ($permissioninfo['login_type'] == '-1' or $permissioninfo['login_type'] == '0' or $permissioninfo['login_type'] == '3' or $permissioninfo['login_type'] == '1') or ($permissioninfo['login_type'] == '-1')) {
                    ?>
                <div id="left_panel_delete"
						class="pull-left margin-t-0 padding-x-4"
						onclick="delete_multiple('/fluxsbc/customer_fssipdevices_delete_multiple/')">
            ...
            <?php
                ...
                if ((isset($permissioninfo['fluxsbc']['fssipdevices']['search'])) && ($permissioninfo['fluxsbc']['fssipdevices']['search'] == 0) && ($permissioninfo['login_type'] == '-1' or $permissioninfo['login_type'] == '0' or $permissioninfo['login_type'] == '3' or $permissioninfo['login_type'] == '1') or ($permissioninfo['login_type'] == '-1')) {
                    ?>
