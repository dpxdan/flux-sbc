...
$(document).ready(function() {
  build_grid("sip_profile_grid","<?php echo base_url(); ?>fluxsbc/fssipprofile_params_json/<?=$edited_id?>",<? echo $grid_fields ?>,'');
...
<div class="card-two card-columns">
		...
		<div class="pop_md col-12 pb-4">
			<div id="floating-label" class="pb-4">
				<form class="row px-4" method="post"
					action="<?= base_url() ?>fluxsbc/fssipprofile_add/edit/"
					...
					<div class="col-12 mt-4 text-center">
						...
						<button class="btn btn-secondary ml-2"
							onclick="javascript:window.location ='<?= base_url() ?>fluxsbc/fssipprofile/'"
		...
		<div class="pop_md col-12 pb-4">
			<div id="floating-label" class="pb-4">
				<form method="post" name="form2" id="form2"
					action="<?= base_url() ?>fluxsbc/fssipprofile_edit"
	...
	<div class="card p-2 text-right">
		<div class="ml-auto">
			...
			&nbsp;<a
				href="<?= base_url()?>/fluxsbc/fssipprofile_action/rescan/<?=$id?>"
				class="" title="rescan"
