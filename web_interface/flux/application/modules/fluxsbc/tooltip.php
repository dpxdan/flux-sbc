...
$tooltip_data = array(
	...
	// ---------------Flux SBC Server Section------------------------

	"fsserver_form_fluxsbc_host" => "",

	"fsserver_form_fluxsbc_password" => "",

	"fsserver_form_fluxsbc_port" => "",
	...
	"form1_sip_port" => "The port on which fluxsbc profile is listening",

	"form1_sip_ip" => "The IP on which fluxsbc profile is listening",
