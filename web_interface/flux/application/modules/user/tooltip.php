...
$tooltip_data = array (
	...
	"user_form_timezone_id" => "Customer Timezone , NOTE : FLUX does not support daylight saving by default. You will need to change the account timezone manually to handle that.",
