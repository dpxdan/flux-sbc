...
(360, 'Powered by FLUX', 'Powered by FLUX'),
(361, 'Prefix', 'Prefix'),
(362, 'Prepend', 'Prepend'),
...
(1521, 'login and signup', 'FLUX - A Smart TelePhony Platform'),
(1522, 'login and signup', 'Forgot Password'),
(1523, 'login and signup', 'FLUX work best with JavaScript enabled'),
...
UPDATE `system` SET `value` = '/var/log/flux/' WHERE `system`.`name` = 'mail_log';
