...
(1, 'log_file', '/var/log/flux/flux.log', 'Where do I log to?', NULL, NULL, NULL),
(2, 'callout_accountcode', 'admin', 'Call Files: What accountcode should we use?', NULL, NULL, NULL),
(3, 'lcrcontext', 'flux-outgoing', 'This is the Local context we use to route our outgoing calls through esp for callbacks', NULL, NULL, NULL),
...
(9, 'callingcards_callback_context', 'flux-callingcards', 'Call Files: For callingcards what context do we end up in?', NULL, NULL, NULL),
...
(18, 'company_email', 'info@flux.org', 'Email address that email should appear to be from', NULL,NULL,NULL),
(19, 'asterisk_dir', '/etc/asterisk', 'Which directory are asterisk configuration files stored in?', NULL,NULL,NULL),
(20, 'company_website', 'http://www.flux.org', 'Link to your company website', NULL,NULL,NULL),
(21, 'company_name', 'FLUX.ORG', 'The name of your company.  Used in emails.', NULL,NULL,NULL),
...
(25, 'emailadd', 'info@flux.org', 'Administrator email address', NULL,NULL,NULL),
...
(28, 'log_file', '/var/log/flux/flux.log', 'FLUX Log file', NULL,NULL,NULL),
(29, 'key_home', 'http://www.flux.org/flux.pub', 'Asterisk RSA Key location (optional)', NULL,NULL,NULL),
(30, 'rate_engine_csv_file', '/var/log/flux/flux.csv', 'CSV File for call rating data', NULL,NULL,NULL),
(31, 'csv_dir', '/var/log/flux/', 'CSV File Directory', NULL,NULL,NULL),
...
(36, 'asterisk_server', 'voip.flux.org', 'Your default voip server.  Used in outgoing email.', NULL,NULL,NULL),
...
(41, 'key', 'flux.pub', 'Asterisk RSA Key Name (Optional)', NULL,NULL,NULL),
...
(52, 'default_language', 'en', 'Default FLUX Language', NULL,NULL,NULL),
...
(60, 'flux_dir', '/var/lib/flux', 'Where do the flux configs live?', NULL,NULL,NULL),
...
(70, 'posttoflux', '1', 'Change this one at your own peril.  If you switch it off, calls will not be written to flux when they are calculated.', NULL,NULL,NULL),
(71, 'sleep', '10', 'How long shall the rating engine sleep after it has been notified of a hangup? (in seconds)', NULL,NULL,NULL),
(72, 'users_dids_amp', '0', 'If this is enabled, FLUX will create users and DIDs in the FreePBX (www.freepbx.org) database.', NULL,NULL,NULL),
(73, 'users_dids_rt', '0', 'If this is enabled, FLUX will create users and DIDs in the Asterisk Realtime database.', NULL,NULL,NULL),
(74, 'users_dids_freeswitch', '1', 'If this is enabled, FLUX will create SIP users in the freeswitch database.', NULL,NULL,NULL),
...
(144, 'calling_cards_welcome_file', 'flux-welcome.wav', 'What do we play for a welcome file?', NULL, NULL, NULL),
