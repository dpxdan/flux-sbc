...
<head>
 ...
 <title>
	...
	<?php
		...
		<? start_block_marker('page-title') ?><? end_block_marker() ?> | Flux Telecom - Unindo pessoas e negócios Solution
	<?php
	}
	?>
</title>
...
<?php } ?>
  ...
  -->
	...
	<?php echo gettext('FLUX work best with JavaScript enabled'); ?>
      </div>
    </noscript>  
...
?>
		    ...
		    <li><a class="dropdown-item" href="https://docs.fluxbilling.org/display/itplmars" target="_blank"><i class="fa fa-file-text"></i> &nbsp;<?php echo gettext('Documentation'); ?></a></li>

<li><a class="dropdown-item" href="https://jira.fluxbilling.org/projects/FLUXUPDATE/" target="_blank"><i class= "fa fa-bug"></i> &nbsp;<?php echo gettext('Report a Bug'); ?></a></li>
...
<div class="btn-quick">
  ...
  <div id="q_menu">
	  <ul class="d-flex flex-column-reverse">
	    ...
	    <li><a href="<?php echo base_url();?>fluxsbc/fssipdevices_add/"  rel="facebox"><?php echo gettext("SIP Devices"); ?></a></li>
	    ...
	    <li><a href="<?php echo base_url();?>fluxsbc/fsgateway_add/" rel="facebox"><?php echo gettext("Gateways"); ?></a></li>
	    ...
	    <li><a href="<?php echo base_url();?>fluxsbc/livecall_report/"><?php echo gettext("Live Calls"); ?></a></li>
	  </ul>
  </div>
 <?php }?> 
