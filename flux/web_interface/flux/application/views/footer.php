  ...
  <?php
    ...
    if($this->session->userdata['logintype'] == 2 || $this->session->userdata['logintype'] == -1 || $this->session->userdata['logintype'] == 1 || $this->session->userdata['logintype'] == 0 ){
     ...
     if(isset($user_footer) && $user_footer != '') {  
      if ($user_footer == 'Flux Telecom. All Rights Reserved.'){
        $user_footer = '';
         } ?>
       <div  class="pull-left col-3 text-left">
     <strong> <span class="text-warning"><?php echo gettext('Flux Telecom - Unindo pessoas e negócios<br>')?> </span></strong>
      </div>
       <?php } ?>
		...
		<div class="col py-2">
  	   		 ...
  	   		 <div class="social-media">
  	   		  ...
  	   		  <a target="_blank" href="https://www.linkedin.com/company/fluxtelecom/" title="Linkedin"> <i class="linkin fa fa-linkedin"></i></a>
    ...
    <?} else {  ?>
      <div class="col-md-5 py-2 px-2 text-md-left text-light">Copyright @ <?php echo date("Y"); ?> <a class="text-warning" href="https://flux.net.br" target="_blank"> <?php echo gettext("Flux Telecom.")?></a>. <?php echo gettext("All Rights Reserved.")?>
...
<div class="col-md-12 float-right pt-3 pr-0 text-light text-md-right version_size"><?php echo gettext("Version")?>  <?php echo common_model::$global_config['system_config']['version'] .' '.gettext('') ;?>
<?php
