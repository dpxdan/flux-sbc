...
class Common_model extends CI_Model {
	...
	function get_dashboard_details(){
		...
		exec("which fs_cli", $fluxsbc_status, $return_var);
		exec($fluxsbc_status[0] ." fs_cli '' -x 'status'", $output5, $return_var);
		$data['fluxsbc_status']= isset($output5) ? json_encode($output5) : '';
		return $data;
	}
