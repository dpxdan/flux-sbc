					...
					<div class="col-md-12 p-0">
						...
						<div class="row p-4">
							<div class="card col-md-7 py-4">
								<div class="card p-4">
									<h4 class="h3 text-truncate text-dark card-title mb-1"><?php echo gettext("FLUX - Unindo pessoas e negócios"); ?></h4>
							...
							<div class="col-md-5 pr-0">
								<div class="card">
									...
									<div class="card-body">
										<h4 class="h4"><?php echo gettext("FLUX - Single Server Installation"); ?></h4>
										<p class="card-text"><?php echo gettext("FLUX - Unindo pessoas e negócios"); ?></p>
										<dl class="row px-4">
											<dt class="text-truncate mr-auto"><?php echo gettext("FLUX - Single Server Installation"); ?></dt>
											<dd>$450.00 USD</dd>
										</dl>
										<dl class="row px-4">
