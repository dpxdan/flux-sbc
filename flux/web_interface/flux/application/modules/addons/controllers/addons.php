    ...
    public function addons_install($type = '', $module = '', $action = '', $version = "", $current_version = "")
    {
        ...
        if ($module != "" && $action != "") {
            ...
            if ($action == 'install' or $action == "update") {
                ...
                if (is_dir($addons_path . $type . "/" . $module . "/fluxsbc/fs/lib/addons")) {
                    // Copy files to web folder but in fs folder
                    echo "Copying file for fluxsbc CDR...<br/>";

                    // Copy fluxsbc cdr process files
                    ...
                    if ($retval == '1') {
                        ...
                        echo "Copy process completed for fluxsbc CDR directories!!<br/><br/>";
                    }
                }

                // if (is_dir ($addons_path.$type."/".$module."/fluxsbc/scripts/flux/lib/addons/"))
                if (is_dir($addons_path . $type . "/" . $module . "/freeswitch/scripts/flux/lib/")) {
                    echo "Copying file for fluxsbc call scripts...<br/>";
                    // Copy files to scripts folder
                    $remove_path = $addons_path . $type . "/" . $module . "/freeswitch/";
                    $add_path = $fs_usr_path;
                    // $path = $addons_path.$type."/".$module."/fluxsbc/scripts/flux/lib/addons/";
                    ...
                    if ($retval == '1') {
                        ...
                        echo "Copy process completed for fluxsbc directories!!<br/><br/>";
                    }
                }
                // ============================ FLUXSBC COPY END ======================
