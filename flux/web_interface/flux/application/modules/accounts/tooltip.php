...
$tooltip_data = array(
	...
	"customer_form_timezone_id" => "Customer Timezone , NOTE : FLUX does not support daylight saving by default. You will need to change the account timezone manually to handle that.",
	...
	"customer_bulk_form_timezone_id" => "Set proper timezone for new account. NOTE : FLUX does not support daylight saving by default. You will need to change the account timezone manually to handle that.",
	...
	"reseller_form_timezone_id" => "Reseller Timezone , NOTE : FLUX does not support daylight saving by default. You will need to change the account timezone manually to handle that.",
	...
	"admin_form_timezone_id" => "Admin Timezone , NOTE : FLUX does not support daylight saving by default. You will need to change the account timezone manually to handle that.",
