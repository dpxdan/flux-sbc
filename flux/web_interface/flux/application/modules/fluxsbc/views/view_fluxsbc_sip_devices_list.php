...
<section class="slice color-three pb-4">
	<div class="w-section inverse p-0">
		...
		<?php
if ((isset($permissioninfo['fluxsbc']['fssipdevices']['create']) && $permissioninfo['fluxsbc']['fssipdevices']['create'] == 0 or ($permissioninfo['login_type'] == '-1' or $permissioninfo['login_type'] == '0' or $permissioninfo['login_type'] == '3'))) {
    ?>

                    <div class="float-left">
						<a href='<?php echo base_url()."fluxsbc/fssipdevices_add/"; ?>'
...
if ((isset($permissioninfo['fluxsbc']['fssipdevices']['delete'])) && ($permissioninfo['fluxsbc']['fssipdevices']['delete'] == 0) or ($permissioninfo['login_type'] == '-1' or $permissioninfo['login_type'] == '1' or $permissioninfo['login_type'] == '3')) {
    ?>
                    <div id="left_panel_delete"
						class="pull-left margin-t-0 padding-x-4"
						onclick="delete_multiple('/fluxsbc/fssipdevices_delete_multiple/')">
